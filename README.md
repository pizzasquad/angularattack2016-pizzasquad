...
* `git clone git@github.com:rumblex/angularattack2016-pizzasquad.git`

* `cd angularattack2016-pizzasquad`
...
If you receive an error message `"You do not have permission to publish to pizzasquad.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add alekos.filini@gmail.com,pietro97venturini@gmail.com,majid70111@gmail.com,simonedegiacomi97@gmail.com`
